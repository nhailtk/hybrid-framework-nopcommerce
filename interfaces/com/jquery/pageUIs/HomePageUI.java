...
public class HomePageUI {
	...
	// Level 11_upload file
	public static final String UPLOAD_FILE = "XPATH=//input[@type='file']";
	public static final String FILE_NAME_LOAD_SUCCESS = "XPATH=//p[@class='name' and contains(text(),'%s')]";
	public static final String FILE_NAME_UPLOAD_SUCCESS = "XPATH=//a[contains(text(),'%s')]";
	public static final String IMAGE_UPLOAD_SUCCESS = "XPATH=//a[@title='%s']/img";
