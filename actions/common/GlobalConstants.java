...
public class GlobalConstants {
	...
	public static final String UPLOAD_FILE = PROJECT_PATH + File.pathSeparator + "uploadFile";
	public static final String DOWNLOAD_FILE = PROJECT_PATH + File.pathSeparator + "downloadFile";
	public static final String BROWSER_LOG = PROJECT_PATH + File.pathSeparator + "browserLogs";
